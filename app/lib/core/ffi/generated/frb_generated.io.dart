...
final class wire_cst_TunnelMode_Socks5 extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_TunnelMode_Socks5> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> url,
  }) => $allocator<wire_cst_TunnelMode_Socks5>()..ref.url = url;
}
...
final class wire_cst_address_balance_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_address_balance_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> address,
    required int balance,
    required int spendable,
    required int pending,
    required ffi.Pointer<ffi.Int64> key_id,
    required int address_id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> label,
    required int created_at,
    required int color_tag,
    required int diversifier_index,
  }) => $allocator<wire_cst_address_balance_info>()
    ..ref.address = address
    ..ref.balance = balance
    ..ref.spendable = spendable
    ..ref.pending = pending
    ..ref.key_id = key_id
    ..ref.address_id = address_id
    ..ref.label = label
    ..ref.created_at = created_at
    ..ref.color_tag = color_tag
    ..ref.diversifier_index = diversifier_index;
}
...
final class wire_cst_address_book_entry_ffi extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_address_book_entry_ffi> $allocate(
    ffi.Allocator $allocator, {
    required int id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> wallet_id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> address,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> label,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> notes,
    required int color_tag,
    required bool is_favorite,
    required int created_at,
    required int updated_at,
    required ffi.Pointer<ffi.Int64> last_used_at,
    required int use_count,
  }) => $allocator<wire_cst_address_book_entry_ffi>()
    ..ref.id = id
    ..ref.wallet_id = wallet_id
    ..ref.address = address
    ..ref.label = label
    ..ref.notes = notes
    ..ref.color_tag = color_tag
    ..ref.is_favorite = is_favorite
    ..ref.created_at = created_at
    ..ref.updated_at = updated_at
    ..ref.last_used_at = last_used_at
...
final class wire_cst_address_display_preference_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_address_display_preference_info> $allocate(
    ffi.Allocator $allocator, {
    required int address_id,
    required bool is_pinned,
    required bool is_archived,
  }) => $allocator<wire_cst_address_display_preference_info>()
    ..ref.address_id = address_id
    ..ref.is_pinned = is_pinned
    ..ref.is_archived = is_archived;
}
...
final class wire_cst_address_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_address_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> address,
    required int diversifier_index,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> label,
    required int created_at,
    required int color_tag,
  }) => $allocator<wire_cst_address_info>()
    ..ref.address = address
    ..ref.diversifier_index = diversifier_index
    ..ref.label = label
    ..ref.created_at = created_at
...
final class wire_cst_background_sync_result extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_background_sync_result> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> mode,
    required int blocks_synced,
    required int start_height,
    required int end_height,
    required int duration_secs,
    required ffi.Pointer<wire_cst_list_String> errors,
    required ffi.Pointer<ffi.Uint64> new_balance,
    required int new_transactions,
  }) => $allocator<wire_cst_background_sync_result>()
    ..ref.mode = mode
    ..ref.blocks_synced = blocks_synced
    ..ref.start_height = start_height
    ..ref.end_height = end_height
    ..ref.duration_secs = duration_secs
    ..ref.errors = errors
    ..ref.new_balance = new_balance
    ..ref.new_transactions = new_transactions;
}
...
final class wire_cst_balance extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_balance> $allocate(
    ffi.Allocator $allocator, {
    required int total,
    required int spendable,
    required int pending,
  }) => $allocator<wire_cst_balance>()
    ..ref.total = total
    ..ref.spendable = spendable
    ..ref.pending = pending;
}
...
final class wire_cst_build_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_build_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> version,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> git_commit,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> build_date,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> rust_version,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> target_triple,
  }) => $allocator<wire_cst_build_info>()
    ..ref.version = version
    ..ref.git_commit = git_commit
    ..ref.build_date = build_date
    ..ref.rust_version = rust_version
    ..ref.target_triple = target_triple;
}
...
final class wire_cst_checkpoint_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_checkpoint_info> $allocate(
    ffi.Allocator $allocator, {
    required int height,
    required int timestamp,
  }) => $allocator<wire_cst_checkpoint_info>()
    ..ref.height = height
...
final class wire_cst_fee_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_fee_info> $allocate(
    ffi.Allocator $allocator, {
    required int default_fee,
    required int min_fee,
    required int max_fee,
    required int fee_per_output,
    required double memo_fee_multiplier,
  }) => $allocator<wire_cst_fee_info>()
    ..ref.default_fee = default_fee
    ..ref.min_fee = min_fee
    ..ref.max_fee = max_fee
    ..ref.fee_per_output = fee_per_output
    ..ref.memo_fee_multiplier = memo_fee_multiplier;
}
...
final class wire_cst_key_address_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_key_address_info> $allocate(
    ffi.Allocator $allocator, {
    required int key_id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> address,
    required int diversifier_index,
    ...
    required int created_at,
    required int color_tag,
  }) => $allocator<wire_cst_key_address_info>()
    ..ref.key_id = key_id
    ..ref.address = address
    ..ref.diversifier_index = diversifier_index
    ..ref.label = label
...
final class wire_cst_key_export_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_key_export_info> $allocate(
    ffi.Allocator $allocator, {
    required int key_id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> sapling_viewing_key,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> ironwood_viewing_key,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> sapling_spending_key,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> ironwood_spending_key,
  }) => $allocator<wire_cst_key_export_info>()
    ..ref.key_id = key_id
    ..ref.sapling_viewing_key = sapling_viewing_key
    ..ref.ironwood_viewing_key = ironwood_viewing_key
    ..ref.sapling_spending_key = sapling_spending_key
    ..ref.ironwood_spending_key = ironwood_spending_key;
}
...
final class wire_cst_key_group_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_key_group_info> $allocate(
    ffi.Allocator $allocator, {
    required int id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> label,
    required int key_type,
    required ffi.Pointer<ffi.Uint32> seed_account_index,
    required bool spendable,
    required bool has_sapling,
    required bool has_ironwood,
    required int birthday_height,
    required int created_at,
  }) => $allocator<wire_cst_key_group_info>()
    ..ref.id = id
    ..ref.label = label
    ..ref.key_type = key_type
    ..ref.seed_account_index = seed_account_index
    ..ref.spendable = spendable
    ..ref.has_sapling = has_sapling
    ..ref.has_ironwood = has_ironwood
    ..ref.birthday_height = birthday_height
    ..ref.created_at = created_at;
}
...
final class wire_cst_lightd_endpoint extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_lightd_endpoint> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> host,
    required int port,
    required bool use_tls,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> tls_pin,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> label,
    required bool automatic_failover,
    required ffi.Pointer<wire_cst_list_String> failover_endpoints,
    required bool is_configured,
  }) => $allocator<wire_cst_lightd_endpoint>()
    ..ref.host = host
    ..ref.port = port
    ..ref.use_tls = use_tls
    ..ref.tls_pin = tls_pin
    ..ref.label = label
    ..ref.automatic_failover = automatic_failover
    ..ref.failover_endpoints = failover_endpoints
    ..ref.is_configured = is_configured;
}
...
final class wire_cst_list_address_balance_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_address_balance_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_address_balance_info> ptr,
    required int len,
  }) => $allocator<wire_cst_list_address_balance_info>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_address_book_entry_ffi extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_address_book_entry_ffi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_address_book_entry_ffi> ptr,
    required int len,
  }) => $allocator<wire_cst_list_address_book_entry_ffi>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_address_display_preference_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_address_display_preference_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_address_display_preference_info> ptr,
    required int len,
  }) => $allocator<wire_cst_list_address_display_preference_info>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_address_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_address_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_address_info> ptr,
    required int len,
  }) => $allocator<wire_cst_list_address_info>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_key_address_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_key_address_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_key_address_info> ptr,
    required int len,
  }) => $allocator<wire_cst_list_key_address_info>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_key_group_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_key_group_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_key_group_info> ptr,
    required int len,
  }) => $allocator<wire_cst_list_key_group_info>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_mnemonic_language extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_mnemonic_language> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Int32> ptr,
    required int len,
  }) => $allocator<wire_cst_list_mnemonic_language>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_output extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_output> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_output> ptr,
    required int len,
  }) => $allocator<wire_cst_list_output>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_payment_disclosure extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_payment_disclosure> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_payment_disclosure> ptr,
    required int len,
  }) => $allocator<wire_cst_list_payment_disclosure>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_sync_log_entry_ffi extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_sync_log_entry_ffi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_sync_log_entry_ffi> ptr,
    required int len,
  }) => $allocator<wire_cst_list_sync_log_entry_ffi>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_tx_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_tx_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_tx_info> ptr,
    required int len,
  }) => $allocator<wire_cst_list_tx_info>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_list_wallet_meta extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_list_wallet_meta> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_wallet_meta> ptr,
    required int len,
  }) => $allocator<wire_cst_list_wallet_meta>()
    ..ref.ptr = ptr
    ..ref.len = len;
}
...
final class wire_cst_mnemonic_inspection extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_mnemonic_inspection> $allocate(
    ffi.Allocator $allocator, {
    required bool is_valid,
    required ffi.Pointer<ffi.Int32> detected_language,
    required ffi.Pointer<wire_cst_list_mnemonic_language> ambiguous_languages,
    required int word_count,
  }) => $allocator<wire_cst_mnemonic_inspection>()
    ..ref.is_valid = is_valid
    ..ref.detected_language = detected_language
    ..ref.ambiguous_languages = ambiguous_languages
...
final class wire_cst_network_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_network_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> name,
    required int coin_type,
    required int rpc_port,
    required int default_birthday,
  }) => $allocator<wire_cst_network_info>()
    ..ref.name = name
    ..ref.coin_type = coin_type
    ..ref.rpc_port = rpc_port
    ..ref.default_birthday = default_birthday;
}
...
final class wire_cst_node_test_result extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_node_test_result> $allocate(
    ffi.Allocator $allocator, {
    required bool success,
    required ffi.Pointer<ffi.Uint64> latest_block_height,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> transport_mode,
    required bool tls_enabled,
    required ffi.Pointer<ffi.Bool> tls_pin_matched,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> expected_pin,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> actual_pin,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> error_message,
    required int response_time_ms,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> server_version,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> chain_name,
  }) => $allocator<wire_cst_node_test_result>()
    ..ref.success = success
    ..ref.latest_block_height = latest_block_height
    ..ref.transport_mode = transport_mode
    ..ref.tls_enabled = tls_enabled
    ..ref.tls_pin_matched = tls_pin_matched
    ..ref.expected_pin = expected_pin
    ..ref.actual_pin = actual_pin
    ..ref.error_message = error_message
    ..ref.response_time_ms = response_time_ms
    ..ref.server_version = server_version
    ..ref.chain_name = chain_name;
}
...
final class wire_cst_output extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_output> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> addr,
    required int amount,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> memo,
  }) => $allocator<wire_cst_output>()
    ..ref.addr = addr
    ..ref.amount = amount
    ..ref.memo = memo;
}
...
final class wire_cst_payment_disclosure extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_payment_disclosure> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> disclosure_type,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> txid,
    required int output_index,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> address,
    required int amount,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> memo,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> disclosure,
  }) => $allocator<wire_cst_payment_disclosure>()
    ..ref.disclosure_type = disclosure_type
    ..ref.txid = txid
    ..ref.output_index = output_index
    ..ref.address = address
    ..ref.amount = amount
    ..ref.memo = memo
    ..ref.disclosure = disclosure;
}
...
final class wire_cst_payment_disclosure_verification extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_payment_disclosure_verification> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> disclosure_type,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> txid,
    required int output_index,
    ...
    required int amount,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> memo,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> memo_hex,
  }) => $allocator<wire_cst_payment_disclosure_verification>()
    ..ref.disclosure_type = disclosure_type
    ..ref.txid = txid
    ..ref.output_index = output_index
    ..ref.address = address
...
final class wire_cst_pending_tx extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_pending_tx> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> id,
    required ffi.Pointer<wire_cst_list_output> outputs,
    required int total_amount,
    required int fee,
    required int change,
    required int input_total,
    required int num_inputs,
    required int expiry_height,
    required int created_at,
  }) => $allocator<wire_cst_pending_tx>()
    ..ref.id = id
    ..ref.outputs = outputs
    ..ref.total_amount = total_amount
    ..ref.fee = fee
    ..ref.change = change
    ..ref.input_total = input_total
    ..ref.num_inputs = num_inputs
    ..ref.expiry_height = expiry_height
    ..ref.created_at = created_at;
}
...
final class wire_cst_seed_export_warnings extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_seed_export_warnings> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> primary,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> secondary,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> backup_instructions,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> clipboard_warning,
  }) => $allocator<wire_cst_seed_export_warnings>()
    ..ref.primary = primary
    ..ref.secondary = secondary
    ..ref.backup_instructions = backup_instructions
    ..ref.clipboard_warning = clipboard_warning;
}
...
final class wire_cst_signed_tx extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_signed_tx> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> txid,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> raw,
    required int size,
  }) => $allocator<wire_cst_signed_tx>()
    ..ref.txid = txid
    ..ref.raw = raw
    ..ref.size = size;
}
...
final class wire_cst_spendability_status extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_spendability_status> $allocate(
    ffi.Allocator $allocator, {
    required bool spendable,
    required bool rescan_required,
    required int target_height,
    required int anchor_height,
    required int validated_anchor_height,
    required bool repair_queued,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> reason_code,
  }) => $allocator<wire_cst_spendability_status>()
    ..ref.spendable = spendable
    ..ref.rescan_required = rescan_required
    ..ref.target_height = target_height
    ..ref.anchor_height = anchor_height
    ..ref.validated_anchor_height = validated_anchor_height
    ..ref.repair_queued = repair_queued
...
final class wire_cst_sync_log_entry_ffi extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_sync_log_entry_ffi> $allocate(
    ffi.Allocator $allocator, {
    required int timestamp,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> level,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> module,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> message,
  }) => $allocator<wire_cst_sync_log_entry_ffi>()
    ..ref.timestamp = timestamp
    ..ref.level = level
    ..ref.module = module
    ..ref.message = message;
...
final class wire_cst_sync_status extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_sync_status> $allocate(
    ffi.Allocator $allocator, {
    required int local_height,
    required int target_height,
    required double percent,
    required ffi.Pointer<ffi.Uint64> eta,
    required int stage,
    required ffi.Pointer<ffi.Uint64> last_checkpoint,
    required double blocks_per_second,
    required int notes_decrypted,
    required int last_batch_ms,
  }) => $allocator<wire_cst_sync_status>()
    ..ref.local_height = local_height
    ..ref.target_height = target_height
    ..ref.percent = percent
    ..ref.eta = eta
    ..ref.stage = stage
    ..ref.last_checkpoint = last_checkpoint
    ..ref.blocks_per_second = blocks_per_second
    ..ref.notes_decrypted = notes_decrypted
    ..ref.last_batch_ms = last_batch_ms;
}
...
final class wire_cst_transaction_cursor extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_transaction_cursor> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Uint32> height,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> txid,
    required int amount,
  }) => $allocator<wire_cst_transaction_cursor>()
    ..ref.height = height
    ..ref.txid = txid
    ..ref.amount = amount;
}
...
final class wire_cst_transaction_page extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_transaction_page> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_tx_info> transactions,
    required ffi.Pointer<wire_cst_transaction_cursor> next_cursor,
  }) => $allocator<wire_cst_transaction_page>()
    ..ref.transactions = transactions
    ..ref.next_cursor = next_cursor;
}
...
final class wire_cst_tx_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_tx_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> txid,
    required ffi.Pointer<ffi.Uint32> height,
    required int timestamp,
    ...
    required ffi.Pointer<ffi.Uint32> expiry_height,
  }) => $allocator<wire_cst_tx_info>()
    ..ref.txid = txid
    ..ref.height = height
    ..ref.timestamp = timestamp
    ..ref.amount = amount
...
final class wire_cst_wallet_background_sync_result extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_wallet_background_sync_result> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> wallet_id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> mode,
    required int blocks_synced,
    ...
    required ffi.Pointer<ffi.Uint64> new_balance,
    required int new_transactions,
  }) => $allocator<wire_cst_wallet_background_sync_result>()
    ..ref.wallet_id = wallet_id
    ..ref.mode = mode
    ..ref.blocks_synced = blocks_synced
    ..ref.start_height = start_height
...
final class wire_cst_wallet_meta extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_wallet_meta> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> id,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> name,
    required int created_at,
    required bool watch_only,
    required int birthday_height,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> network_type,
  }) => $allocator<wire_cst_wallet_meta>()
    ..ref.id = id
    ..ref.name = name
    ..ref.created_at = created_at
    ..ref.watch_only = watch_only
    ..ref.birthday_height = birthday_height
    ..ref.network_type = network_type;
}
...
final class wire_cst_watch_only_banner_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_watch_only_banner_info> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> banner_type,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> title,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> subtitle,
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> icon,
  }) => $allocator<wire_cst_watch_only_banner_info>()
    ..ref.banner_type = banner_type
    ..ref.title = title
...
final class wire_cst_watch_only_capabilities_info extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_watch_only_capabilities_info> $allocate(
    ffi.Allocator $allocator, {
    required bool can_view_incoming,
    required bool can_view_outgoing,
    required bool can_spend,
    required bool can_export_seed,
    required bool can_generate_addresses,
    required bool is_watch_only,
  }) => $allocator<wire_cst_watch_only_capabilities_info>()
    ..ref.can_view_incoming = can_view_incoming
    ..ref.can_view_outgoing = can_view_outgoing
    ..ref.can_spend = can_spend
    ..ref.can_export_seed = can_export_seed
    ..ref.can_generate_addresses = can_generate_addresses
    ..ref.is_watch_only = is_watch_only;
}
...
final class wire_cst_witness_refresh_outcome extends ffi.Struct {
  ...
  static ffi.Pointer<wire_cst_witness_refresh_outcome> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<wire_cst_list_prim_u_8_strict> source,
    required int sapling_requested,
    required int sapling_updated,
    required int sapling_missing,
    required int sapling_errors,
    required int ironwood_requested,
    required int ironwood_updated,
    required int ironwood_missing,
    required int ironwood_errors,
  }) => $allocator<wire_cst_witness_refresh_outcome>()
    ..ref.source = source
    ..ref.sapling_requested = sapling_requested
    ..ref.sapling_updated = sapling_updated
    ..ref.sapling_missing = sapling_missing
    ..ref.sapling_errors = sapling_errors
    ..ref.ironwood_requested = ironwood_requested
    ..ref.ironwood_updated = ironwood_updated
    ..ref.ironwood_missing = ironwood_missing
    ..ref.ironwood_errors = ironwood_errors;
}
