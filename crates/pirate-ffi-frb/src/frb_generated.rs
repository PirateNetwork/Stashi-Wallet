    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::export_seed_for_kdf(api_wallet_id)?;
                        std::result::Result::Ok(output_ok)
                    })(),
                )
            }
        ...
        move || {
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::endpoint::LightdEndpoint::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::endpoint::LightdEndpoint::url(&api_that))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__witness_refresh_outcome_default_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        ...
        move || {
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::WitnessRefreshOutcome::default())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
mod io {
    ...
    pub extern "C" fn frbgen_pirate_wallet_wire__crate__api__export_seed_for_kdf(
        ...
        wire__crate__api__export_seed_for_kdf_impl(port_, wallet_id)
    }
